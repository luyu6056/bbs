...
func (c *Context) Out_common(result int16, url string) {
	msg := protocol.Pool_MSG_WS2U_CommonResult.Get().(*protocol.MSG_WS2U_CommonResult)
	msg.Result = result
	msg.Err_url = url
	c.Output_data(msg)
	msg.Put()
