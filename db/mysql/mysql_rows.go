...
var rows_pool = sync.Pool{New: func() interface{} {
	row := &MysqlRows{Buffer: new(libraries.MsgBuffer), Buffer2: new(libraries.MsgBuffer), field_m: make(map[string]map[string]*Field_struct)}
